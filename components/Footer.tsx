    ...
    <footer className="py-8 bg-gray-900 text-slate-200">
      ...
      <div className="container px-4 py-4 mx-auto">
        ...
        <div className="text-sm text-center">
          © {new Date().getFullYear()} CoolCriminal Universe DeFi. All rights reserved.
          <br />
          Made with ❤️ by{" "}
          <Link href="https://coolcriminal.space" target="_blank">
            <span className="font-bold text-teal-400">CCUniverse</span>
          </Link>
        </div>
      </div>
    </footer>
