...
const launchpadItems: LaunchpadItem[] = [
  ...
  {
    name: "CCUniverse MEME Released",
    description: "Project CCUM released",
    time: "10m ago",
    icon: "💰",
    color: "#FFB800",
  },
  {
    ...
    description: "Project IBCM, CCUM presale Starts",
    time: "5m ago",
    icon: "👥",
    color: "#FF3D71",
  },
  {
    ...
    description: "Project CCUN launches in 20th July 2025",
    time: "2m ago",
    icon: "⏳",
    color: "#1E86FF",
  },
    ...
    <section className="min-h-screen px-4 py-10 bg-gradient-to-b from-background to-slate-900 sm:px-6 lg:px-8">
      <div className="flex flex-col items-center justify-center w-full pt-20">
        <GradualSpacing
          ...
          text="CoolCriminal Universe DeFi"
        />
      </div>
